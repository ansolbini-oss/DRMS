...
// [Phase 17-DI] phone 필드 추가 (검색 대상 확장). MFA 필드는 표시에서 제거되어 dormant.
const DEMO_ACCOUNTS = [
  {id:'u001', email:'admin@60hz.io',     name:'현진영', empNo:'20200001', phone:'010-1000-0001', role:'SYS_ADMIN',       team:'IT운영팀',   position:'CTO',     status:'ACTIVE',  lastLogin:'2026-04-21 13:42', lastIp:'10.0.1.12',   validUntil:null, createdAt:'2024-03-01'},
  {id:'u002', email:'jho.park@60hz.io',  name:'박재호', empNo:'20200015', phone:'010-2000-0015', role:'DR_OPERATOR',     team:'DR운영팀',   position:'팀장',    status:'ACTIVE',  lastLogin:'2026-04-21 09:15', lastIp:'10.0.1.34',   validUntil:null, createdAt:'2024-05-12'},
  {id:'u003', email:'syj.kim@60hz.io',   name:'김수연', empNo:'20210042', phone:'010-2100-0042', role:'DR_OPERATOR',     team:'DR운영팀',   position:'매니저',  status:'ACTIVE',  lastLogin:'2026-04-20 18:33', lastIp:'10.0.1.58',   validUntil:null, createdAt:'2024-06-21'},
  {id:'u004', email:'hjs.lee@60hz.io',   name:'이현수', empNo:'20220103', phone:'010-2200-0103', role:'SETTLEMENT',      team:'정산팀',     position:'팀장',    status:'ACTIVE',  lastLogin:'2026-04-21 10:07', lastIp:'10.0.1.71',   validUntil:null, createdAt:'2024-08-05'},
  {id:'u005', email:'ebs.choi@60hz.io',  name:'최은비', empNo:'20230071', phone:'010-2300-0071', role:'SETTLEMENT',      team:'정산팀',     position:'주임',    status:'LOCKED',  lastLogin:'2026-04-18 16:22', lastIp:'10.0.1.88',   validUntil:null, createdAt:'2024-11-18'},
  {id:'u006', email:'dw.jung@60hz.io',   name:'정도원', empNo:'20230112', phone:'010-2301-0112', role:'CUSTOMER_SUPPORT',team:'고객지원팀', position:'매니저',  status:'ACTIVE',  lastLogin:'2026-04-21 11:04', lastIp:'10.0.2.10',   validUntil:null, createdAt:'2024-12-03'},
  {id:'u007', email:'sh.yoon@60hz.io',   name:'윤소현', empNo:'20230145', phone:'010-2301-0145', role:'CUSTOMER_SUPPORT',team:'고객지원팀', position:'주임',    status:'ACTIVE',  lastLogin:'2026-04-20 17:51', lastIp:'10.0.2.14',   validUntil:null, createdAt:'2025-01-14'},
  {id:'u008', email:'inspector@audit.ext',name:'감사원 김', empNo:'EXT001',phone:'010-9000-0001', role:'VIEWER',        team:'외부파트너',  position:'감사인',  status:'ACTIVE',  lastLogin:'2026-04-15 10:00', lastIp:'218.55.12.3', validUntil:'2026-06-30', createdAt:'2025-12-01'},
  {id:'u009', email:'tmp.partner@60hz.io',name:'장민호', empNo:'TMP023',   phone:'010-9000-0023', role:'DR_OPERATOR',   team:'외부파트너',  position:'파트너',  status:'EXPIRED', lastLogin:'2026-03-12 14:00', lastIp:'221.148.9.77',validUntil:'2026-04-01', createdAt:'2025-10-01'},
  {id:'u010', email:'newbie@60hz.io',     name:'신입사원', empNo:'20260001',phone:'010-2600-0001', role:'VIEWER',       team:'운영본부',    position:'사원',    status:'PENDING', lastLogin:'-',                lastIp:'-',           validUntil:null, createdAt:'2026-04-20'},
  {id:'u011', email:'dormant@60hz.io',    name:'한지훈', empNo:'20190003', phone:'010-1900-0003', role:'DR_OPERATOR',   team:'DR운영팀',    position:'매니저',  status:'ACTIVE',  lastLogin:'2025-11-10 09:00', lastIp:'10.0.1.44',   validUntil:null, createdAt:'2019-05-10'},
  {id:'u012', email:'resigned@60hz.io',   name:'전영주', empNo:'20210088', phone:'010-2100-0088', role:'DR_OPERATOR',   team:'DR운영팀',    position:'매니저',  status:'INACTIVE',lastLogin:'2026-02-28 18:00', lastIp:'10.0.1.66',   validUntil:null, createdAt:'2021-04-01'},
];
